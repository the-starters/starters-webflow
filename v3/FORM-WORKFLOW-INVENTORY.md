...
| Starter Edit Profile | Xano | GitHub: `starter-edit-profile.js`; scoped inline replacement assets in [`starter-edit-profile/`](starter-edit-profile/README.md) | PR #399 | Six self-contained blocks are ready for exact loader replacement; the final submit and excluded field coupling remain inline |
