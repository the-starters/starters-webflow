...
| Starter Edit Profile | Xano | GitHub: `starter-edit-profile.js`; scoped inline replacement assets in [`starter-edit-profile/`](starter-edit-profile/README.md) | PR #399 for final submit plus exact-endpoint photo, portfolio, and company-experience receipts in this PR | Native Designer form markup remains; `starter-edit-profile.js` owns all six section controllers, including final submit. The separate scoped extraction follows the linked contract |
