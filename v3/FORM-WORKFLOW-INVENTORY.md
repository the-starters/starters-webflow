...
| Brand signup, `/sign-up` and Quiz signup | Memberstack, then Xano webhook | GitHub: `brand-account-controller.js`, `native-form-diagnostics.js`, `signup-attribution.js`, Quiz controllers | Native-form observer in this PR | No page-specific writer found |
...
| Build Profile Consult / Full Profile | Xano | Mixed: GitHub assets in [`build-profile/`](build-profile/README.md) plus untouched inline Webflow blocks | GitHub submit observer plus exact-endpoint photo, portfolio, and company-experience receipts in this PR; does not alter the coupled writer | Nine self-contained blocks plus an observer-only loader are ready; excluded coupled blocks remain inline |
...
| Starter Edit Profile | Xano | GitHub: `starter-edit-profile.js`; scoped inline replacement assets in [`starter-edit-profile/`](starter-edit-profile/README.md) | PR #399 for final submit plus exact-endpoint photo, portfolio, and company-experience receipts in this PR | Six self-contained blocks are ready for exact loader replacement; the final submit and excluded field coupling remain inline |
