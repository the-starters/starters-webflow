...
- `v3/starter-project-form.js` — V3 Starter Dashboard adapter for the existing Start a Project modal; loads authorized Brands and creates an idempotent canonical project whose Standard Contract can be signed by either party first; see [`v3/STARTER-PROJECT-FORM-WIRING.md`](v3/STARTER-PROJECT-FORM-WIRING.md) for the authoritative scope, endpoint, Designer, and release contract
