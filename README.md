...
- `quiz-main/quiz-redirect.js` — `/quiz` member redirect; sends live or Test paid Brands to `/brand-dashboard` and completed free Brands to `/quiz-results` unless the URL opts into a retake, and Talent members to `/starter-dashboard` whether or not it does
