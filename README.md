...
- `global-embeds/form-embeds/password-validation/password-validation.js` — password-requirements checklist with submit gating; each instance picks its rule set through `starters-password-validation-*` wrapper attributes ([docs](https://wf-starter-embeds-docs.vercel.app/docs/global-embeds/form-embeds/password-validation))
