...
- `v3/brand-account-controller.js` — Memberstack-first Brand signup and Build Account controller plus configuration-gated Account Security ownership for Brand and Talent members. The authoritative signup mapping, identity scope, propagation contract, failure semantics, and reversible canaries live in [`v3/BRAND-ACCOUNT-WIRING.md`](v3/BRAND-ACCOUNT-WIRING.md)
