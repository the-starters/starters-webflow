...
- `v3/hire-profile-favorites.js` — paid-Brand favourite hydration for Designer-authored hearts on `/hire/<slug>`; does not use `data-starters-list`. Install and plan-gate live in [`v3/README.md`](v3/README.md#hire-profile-favorites) and [`docs/wiring/HIRE-PROFILE-WIRING.md`](docs/wiring/HIRE-PROFILE-WIRING.md#install)
