...
- `v3/starter-dashboard-messages.js` — shared Brand/Starter dashboard Messages tile: merges Xano recent conversations with TalkJS live unreads, uses the other participant's TalkJS name/photo for read one-on-one threads, and opens the selected conversation in a new `/messages` tab. See [`v3/README.md`](v3/README.md#brand-and-starter-dashboard-messages-tile)
