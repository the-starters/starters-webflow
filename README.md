...
- `v3/starter-edit-profile/canonical-profile-loader.js` — read-only canonical Xano hydration plus step-scoped unsaved-change state for authored Starter Edit Profile fields; hydration and accepted saves stay clean, while real edits, failed saves, and active saves keep the browser navigation warning
