...
- `global-embeds/form-embeds/memberstack-loader/memberstack-loader.js` — dresses a Memberstack auth form's Button as busy and disabled while Memberstack shows its `data-ms-loader` spinner, restores it on hide; loader routing, double-submit guard and diagnostics follow in later tickets
