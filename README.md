...
- `v3/profile-form/` — shared Build/Edit Profile inline-extraction candidates plus the whole-dollar price contract the Build and Edit Profile forms enforce on hourly, monthly retainer, and custom-service prices, and on the Dashboard-owned Paid Call rate on Edit Profile only, before any Xano request; the authoritative ownership, provenance, page-Head-Code cutover, loader order, verification, and [price ranges and rejection rules](v3/profile-form/README.md#whole-dollar-price-contract) live in [`v3/profile-form/README.md`](v3/profile-form/README.md)
