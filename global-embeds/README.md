...
Each subfolder corresponds to a component/feature embedded in Webflow
(accordions, modal, step-flow, form-embeds, etc.). Loose `.js` files at the top
level are standalone embeds.
